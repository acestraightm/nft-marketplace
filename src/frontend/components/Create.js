...
const Create = ({marketplace, nft}) => {
  ...
  return (
    <div className="container-fluid mt-5">
      <div className="row">
        <main role="main" className="col-lg-12 mx-auto" style={{maxWidth: '1080px'}}>
          <div className="content mx-auto">
            <Row className="g-4">
              <Form.Control type="file" name="file" size="lg" onChange={uploadToIPFS} />
              <Form.Control onChange={e => setName(e.target.value)} size="lg" type="text" placeholder="Name" />
              <Form.Control onChange={e => setDescription(e.target.value)} size="lg" type="description" placeholder="Description" />
